namespace QuotesAPi.Migrations
{
    ...
    public partial class ValidationAdded : DbMigration
    {
        ...
        {
            AlterColumn("dbo.Quotes", "Title", c => c.String(nullable: false, maxLength: 50));
            AlterColumn("dbo.Quotes", "Author", c => c.String(nullable: false, maxLength: 50));
            AlterColumn("dbo.Quotes", "Description", c => c.String(nullable: false, maxLength: 500));
            AlterColumn("dbo.Quotes", "Type", c => c.String(nullable: false, maxLength: 20));
        }
